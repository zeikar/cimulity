 ...
 * `PlaceStructureCommand` — place a power plant, water tower, police station, or fire station anchored at (x, y)
...
/**
 * Place a service structure (power plant, water tower, police station, or fire station)
...
export interface PlaceStructureCommand {
  ...
  /** NW anchor y */
  readonly y: number;
  readonly structureType: 'power_plant' | 'water_tower' | 'police_station' | 'fire_station';
}
