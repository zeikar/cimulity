/**
 * Player-placed service structures (power plants, water towers, police stations, fire stations). SEPARATE from
...
export type StructureType = 'power_plant' | 'water_tower' | 'police_station' | 'fire_station';

export function isStructureType(s: string): s is StructureType {
  return s === 'power_plant' || s === 'water_tower' || s === 'police_station' || s === 'fire_station';
}
 ...
 *  service block. The switch exhaustiveness check catches any omitted type. */
